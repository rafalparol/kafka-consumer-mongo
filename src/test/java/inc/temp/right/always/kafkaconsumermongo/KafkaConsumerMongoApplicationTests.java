...
import inc.temp.right.always.kafkaconsumermongo.listeners.KafkaConsumerListener;
...
class KafkaConsumerMongoApplicationTests {
	@Test
	void KafkaConsumerListener_handleTemperatureMeasurement_Test() {
		...
		TempMeasurement tempMeasure = new TempMeasurement("thermometer-1-" + Timestamp.valueOf("2024-02-01 00:00:01").toInstant().toEpochMilli(), "thermometer-1", Timestamp.valueOf("2024-02-01 00:00:01").toInstant().toEpochMilli(), "room-1", 20.0);
